...
class LedgerManager
{
  public:
    ...
    // Queue a batch of LedgerEntries to send to the BucketManager on the
    // next ledger, instead of the entries generated by the LedgerTxn.
    virtual void setNextLedgerEntryBatchForBucketTesting(
