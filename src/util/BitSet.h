...
class BitSet
{
  ...
  public:
    ...
    BitSet
    symmetric_difference(BitSet const& other) const
    {
        BitSet tmp(*this);
    ...
    size_t
    union_count(BitSet const& other) const
    {
        return bitset_union_count(mPtr.get(), other.mPtr.get());
    }
    size_t
    intersection_count(BitSet const& other) const
    {
        return bitset_intersection_count(mPtr.get(), other.mPtr.get());
    }
    size_t
    difference_count(BitSet const& other) const
    {
        return bitset_difference_count(mPtr.get(), other.mPtr.get());
    }
    size_t
    symmetric_difference_count(BitSet const& other) const
    {
