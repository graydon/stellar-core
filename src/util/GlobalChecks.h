...
[[noreturn]] void printAssertFailureAndAbort(const char* s1, const char *file, int line);
[[noreturn]] void printAssertFailureAndThrow(const char* s1, const char *file, int line);
...
(static_cast<bool>(e) ? void (0) : printAssertFailureAndAbort(#e, __FILE__, __LINE__))

// Same as above, but throwing rather than aborting.
#define releaseAssertOrThrow(e) \
(static_cast<bool>(e) ? void (0) : printAssertFailureAndThrow(#e, __FILE__, __LINE__))
